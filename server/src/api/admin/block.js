...
block_router.delete('/', (req, res) => {
    ...
    const query = `DELETE FROM Block
                    WHERE user_id = (
                    SELECT user_id FROM Account WHERE email = '${user_email}')`

    const query_change_status = `UPDATE Account SET is_blocked = false WHERE email = '${user_email}'`
