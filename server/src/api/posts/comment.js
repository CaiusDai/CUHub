...
comment_router.post('/', async (req, res) => {
    ...
    try {
        //Update Post table
        const query_add_number = `UPDATE Post SET numcomment = numcomment + 1 WHERE post_id = ${post_id}`
        await database.query(query_add_number)

        //Then adding record to Comment table
        ...
        //Then insert record to comment table
        const query_insert_record = `INSERT INTO Comment (DEFAULT,${user_id},${post_id},${user_id_other},'${commentContent}',DEFAULT})`
